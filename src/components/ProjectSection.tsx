...
const ProjectsSection: FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 py-8 md:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl md:text-4xl font-bold text-white mb-6 md:mb-12 text-center">
          Featured Projects
        </h2>

        <div className="space-y-6 md:space-y-12">
          {projects.map((project, index) => (
            <div key={index} className="group relative bg-slate-800 rounded-xl p-4 md:p-6 hover:bg-slate-700/50 transition-all duration-300">
                ...
                <div className="space-y-3 md:space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech) => (
                      <span 
                        key={tech}
                        className="px-2 py-1 text-xs md:text-sm bg-blue-500/10 text-blue-400 rounded-full"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-1 md:space-y-2">
                      {project.features.map((feature) => (
                        <li key={feature} className="flex items-center gap-2 text-sm md:text-base text-slate-300">
                  ...
                  <div className="flex flex-wrap gap-3 mt-4">
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-blue-600 text-white text-sm md:text-base rounded-lg hover:bg-blue-700 transition-colors"
                    >
                      <svg className="w-3 h-3 md:w-4 md:h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-slate-700 text-white text-sm md:text-base rounded-lg hover:bg-slate-600 transition-colors"
                    >
                      <svg className="w-3 h-3 md:w-4 md:h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-slate-700 text-white text-sm md:text-base rounded-lg hover:bg-slate-600 transition-colors"
                    >
                      <svg className="w-3 h-3 md:w-4 md:h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
